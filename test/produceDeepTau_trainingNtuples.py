...
inputDir_sample = {
  ...
  'qcd_pt30to50'   : os.path.join(inputDir, "qcd_pt30to50"),
  'qcd_pt50to80'   : os.path.join(inputDir, "qcd_pt50to80"),
...
regexp_sample = {
  ...
  'qcd_pt30to50'   : "[a-zA-Z0-9_/:.-]*produceDeepTau_rawNtuple_[a-zA-Z0-9_/:.-]+.root",
  'qcd_pt50to80'   : "[a-zA-Z0-9_/:.-]*produceDeepTau_rawNtuple_[a-zA-Z0-9_/:.-]+.root",
...
for sample in [ "qqH_htt", "minbias", "qcd_pt30to50", "qcd_pt50to80", "qcd_pt80to120", "qcd_pt120to170", "dy_mass10to50", "dy_massGt50", "w" ]:
...
command = 'ShuffleMerge --cfg $CMSSW_BASE/src/TauMLTools/Analysis/config/training_inputs_step2_Phase2HLT.cfg --input %s --output %s --pt-bins "20, 1000" --eta-bins "0., 2.4" --mode MergeAll --calc-weights false --ensure-uniformity true --max-bin-occupancy 500000 --n-threads 12' % \
  (outputDir_ShuffleMerge, "%s")
